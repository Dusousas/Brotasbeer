                ...
                <div className='maxWidth flex flex-col gap-20 lg:flex-row'>
                    ...
                    <article className='w-full lg:w-1/2'>
                        ...
                        <p className='text-textGray flex gap-2 items-center mt-2'>
                            <FontAwesomeIcon className='text-textGreen text-lg' icon={faLocationDot} />R. Ângelo Martineli, 85 - São João, Brotas - SP.</p>
                        <p className='text-textGray flex gap-2 items-center mt-2'>
                            <FontAwesomeIcon className='text-textGreen text-lg' icon={faPhone} />+55 (14) 99882-2200</p>
                        <p className='text-textGray flex gap-2 items-center mt-2'>
                            <FontAwesomeIcon className='text-textGreen text-lg' icon={faEnvelope} />falecom@brotasbeer.com.br</p>
                    </article>
