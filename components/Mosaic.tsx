        ...
        <div>
            <section id='about' className=''>
                <div className="grid grid-cols-1 lg:grid-cols-4 grid-rows-4 gap-0">
                    ...
                    {/* PREMIOS */}
                    <div onClick={handlePremiosClick} className="lg:col-span-2 lg:row-span-2 relative group cursor-pointer">
                        <img className='w-full h-[300px] object-cover object-top transition-opacity duration-300 group-hover:opacity-75' src="grid1.png" alt="Premios" />
                    ...
                    {/* CHOPP DELIVERY */}
                    <div onClick={handleChoppDeliveryClick} className="lg:col-span-2 lg:row-span-2 lg:col-start-3 relative group cursor-pointer">
