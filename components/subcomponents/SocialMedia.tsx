    ...
    return (
        <>
            <section className="relative z-10 ">
                ...
                {isOpen && (
                    <div
                        className={`fixed top-0 right-0 h-full w-full max-w-[500px] bg-black  text-white p-8 shadow-lg transform transition-transform duration-300 ease-in-out ${
                    ...
                    >
                        <div className="flex flex-col items-center justify-center h-full text-center space-y-6">
                            ...
                            <div className="text-3xl font-bold">
                                <img src="logo.png" alt="BROTAS BEER" className="mb-2" />
                            </div>
